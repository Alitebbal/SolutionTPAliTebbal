...
#include "Menus2054583.h"		// Bibliothèque du programmeur rassemblant les fonctions permettant la gestion des menus et la validation des choix fait dans ces menus
#include "Formes2054583.h"		// Bibliothèque du programmeur offrant des fonctions permettant de dessiner différentes formes, pleines ou vides
using namespace std;

int main()
{
	// Définition des constantes 
	const int QUITTER = 6;     // Le choix maximum dans le menu 1. Pourrait changer si le programmeur ajoute une forme suppplémentaire
